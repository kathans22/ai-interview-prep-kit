...
const COMMON_INSTRUCTIONS = [
  ...
  '',
  'GROUND EVERY QUESTION IN THIS ROLE. You are given the company, what it does, and the',
  'responsibilities. Use them. A question that would read identically in any job posting',
  'for this technology has failed, however technically sharp it is — the candidate can',
  'get generic questions anywhere, and the point of this kit is that it was built from',
  'THIS posting.',
  '',
  '  WEAK  (could be any React job): "How would you choose between Jotai and Redux',
  '        Toolkit for high-frequency updates?"',
  '  STRONG (same requirement, this role): "The operator console receives telemetry from',
  '        400 vehicles at once. How would you structure that state so a burst of updates',
  '        does not stall the dispatcher\'s screen?"',
  'The strong version tests the same knowledge and is answerable only by someone thinking',
  'about this job.',
  '',
  'Where the context is thin, stay concrete about the WORK rather than naming products:',
  'the domain, the users, the scale figure, the failure that would matter here. Do not',
  'invent company facts to fill the gap, and do not name specific libraries, vendors or',
  'tools the posting never mentioned — asking someone to compare two products you chose',
  'for them tests your preferences, not their judgement.',
  '',
